...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1183c81f-1b06-4c1e-8e71-437df39c754b
```

> `1183c81f-1b06-4c1e-8e71-437df39c754b` is the password of the certificate, you can change it to any password you want.
